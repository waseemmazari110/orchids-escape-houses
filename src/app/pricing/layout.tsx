...
export const metadata: Metadata = {
  ...
  description: "Clear hen party house pricing. Weekend from £89pp, midweek from £69pp. 25% deposit, balance 8 weeks before. No hidden fees.",
  ...
  openGraph: {
    ...
    description: "Clear pricing from £69pp with no hidden fees. Deposits and payment terms explained.",
